...
def conv_block(inp, times, has_input=False):
    ...
    for i in range(times):
        conv1 = LeakyReLU()(Conv2D(32, (3, 3), padding='same')(x))
        conv2 = LeakyReLU()(Conv2D(32, (5, 5),  padding='same')(x))
        conv3 = LeakyReLU()(Conv2D(32, (7, 7),  padding='same')(x))
        conv4 = LeakyReLU()(Conv2D(32, (9, 9),  padding='same')(x))
