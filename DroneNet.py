    ...
    def __init__(self,loading=False):
        ...
        with self.session.as_default():
            with self.graph.as_default():       
                self.inp=Input((WINDOW_SIZE,WINDOW_SIZE,DroneNet._in_channel),dtype='float32')
                ...
                self.out=Conv2DTranspose(DroneNet._out_channel,(3,3),activation='softmax',padding='same')(self.deconv4)
